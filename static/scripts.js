...
function addMarker(place)
{
    ...
    // icon for the marker
    var image = "https://cdn4.iconfinder.com/data/icons/SUNNYDAY/mail_icons/png/32/news2.png";
    ...
    var marker = new google.maps.Marker({
        ...
        label: {text: place["place_name"] +", "+ place["admin_name1"], color: 'crimson', textsize:'10',},
        icon : image
    });
